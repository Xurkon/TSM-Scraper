...
### v3.3.5 - Refresh Button

- **Added Refresh Button**: Click 🔄 next to profile dropdown to reload SavedVariables file
- Useful after doing `/reload` in WoW to see new groups
